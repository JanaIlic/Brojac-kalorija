namespace API.Controllers
{
    ...
    public class KorisnikController : ControllerBase
    {
        ...
        public async Task<ActionResult<Korisnik>> KorisnikPoID(int id)
        {
        ...
        public async Task<ActionResult<bool>> Pracen(int id)
        {
            var korisnik = await inalog.KorisnikPoID(id);
            if (korisnik == null)
                return NotFound("Ne postoji traženi korisnik.");
        ...
        public async Task<ActionResult<bool>> Pratilac(int id)
        {
            var korisnik = await inalog.KorisnikPoID(id);
            if (korisnik == null)
                return NotFound("Ne postoji traženi korisnik.");
