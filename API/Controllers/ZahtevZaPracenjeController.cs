namespace API.Controllers
{
    ...
    public class ZahtevZaPracenjeController : ControllerBase
    {
        ...
        public async Task<ActionResult<ZahtevZaPracenje>> NadjiPoslatZahtev(int zahtevID)
        {
        ...
        public async Task<ActionResult<ZahtevZaPracenje>> NadjiPrimljenZahtev(int zahtevID)
        {
        ...
        public async Task<ActionResult<RezultatZahteva>> RezultatPoslatogZahteva(int zahtevID)
        {
            var zahtev = await izahtev.NadjiPoslatZahtev(zahtevID);
            if (zahtev == null)
                return NotFound("Traženi zahtev ne postoji, ili je uklonjen.");
        ...
        public async Task<ActionResult<RezultatZahteva>> RezultatPrimljenogZahteva(int zahtevID)
        {
            var zahtev = await izahtev.NadjiPrimljenZahtev(zahtevID);
            if (zahtev == null)
                return NotFound("Traženi zahtev ne postoji, ili je uklonjen.");

            var rezultat = await izahtev.RezultatPrimljenogZahteva(zahtev);
            if (rezultat == null)
                return NotFound("Ne postoji rezultat traženog zahteva.");
        ...
        public async Task<ActionResult<bool>> ZahtevPoslatKorisniku(int primalacID) 
        {
        ...
        public async Task<ActionResult<ZahtevZaPracenje>> PosaljiZahtev(int id, bool prijava, string pozdrav)
        {
        ...
        public async Task<ActionResult<ZahtevZaPracenje>> PrihvatiZahtev(int zahtevID)
        {
            var zahtev = await izahtev.NadjiPrimljenZahtev(zahtevID);
            if (zahtev == null)
                return NotFound("Traženi zahtev ne postoji, ili je uklonjen.");
        ...
        public async Task<ActionResult<ZahtevZaPracenje>> OdbijZahtev(int zahtevID)
        {
            var zahtev = await izahtev.NadjiPrimljenZahtev(zahtevID);
            if (zahtev == null)
                return NotFound("Traženi zahtev ne postoji, ili je uklonjen.");
        ...
        public async Task<ActionResult<ZahtevZaPracenje>> PovuciZahtev(int zahtevID)
        {
        ...
        public async Task<ActionResult<string>> Otprati(int pracenID) 
        {
        ...
        public async Task<ActionResult<string>> ObrisiPratioca(int pratilacID)
        {
