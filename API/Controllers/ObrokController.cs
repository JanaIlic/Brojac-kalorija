namespace API.Controllers
{
    ...
    public class ObrokController : ControllerBase
    {
        ...
        public async Task<ActionResult<Obrok>> NadjiObrokPoIDu(int id)
        {
        ...
        public async Task<ActionResult<ICollection<Obrok>>> NadjiObrokeDana(int danID)
        {
        ...
        public async Task<ActionResult<ICollection<Jelo>>> JeloObroka(int obrokID, int jeloID)
        {
        ...
        public async Task<ActionResult<ICollection<Jelo>>> JelaObroka(int obrokID)
        {
            var obrok = await iobrok.ObrokPoIDu(obrokID);
            if (obrok == null)
                return NotFound("Ne postoji traženi obrok.");
        ...
        public async Task<ActionResult<ICollection<double>>> MaseJela(int obrokID)
        {
            var obrok = await iobrok.ObrokPoIDu(obrokID);
            if (obrok == null)
                return NotFound("Ne postoji traženi obrok.");
        ...
        public async Task<ActionResult<ICollection<double>>> EvJela(int obrokID)
        {
            var obrok = await iobrok.ObrokPoIDu(obrokID);
            if (obrok == null)
                return NotFound("Ne postoji traženi obrok.");
        ...
        public async Task<ActionResult<bool>> ObrokDodatDanas(int obrokID)
        {
            var obrok = await iobrok.ObrokPoIDu(obrokID);
            if (obrok == null)
                return NotFound("Ne postoji traženi obrok.");
        ...
        public async Task<ActionResult<string>> OpisObroka(int obrokID) 
        {
            var obrok = await iobrok.ObrokPoIDu(obrokID);
            if (obrok == null)
                return NotFound("Ne postoji traženi obrok.");
        ...
        public async Task<ActionResult<Obrok>> DodajObrok(int obrokID)
        {
            var obrok = await iobrok.ObrokPoIDu(obrokID);
            if (obrok == null)
                return NotFound("Ne postoji traženi obrok.");
        ...
        public async Task<ActionResult<Objava>> ObjaviObrok(int obrokID)
        {
            var obrok = await iobrok.ObrokPoIDu(obrokID);
            if (obrok == null)
                return NotFound("Ne postoji traženi obrok.");
        ...
        public async Task<ActionResult<Obrok>> PromeniNaziv(int obrokID, string naziv) 
        {
            var obrok = await iobrok.ObrokPoIDu(obrokID);
            if (obrok == null)
                return NotFound("Ne postoji traženi obrok.");
        ...
        public async Task<ActionResult<Obrok>> PromeniMasuObroka(int obrokID, double masa)
        {
            var obrok = await iobrok.ObrokPoIDu(obrokID);
            if (obrok == null)
                return NotFound("Ne postoji traženi obrok.");
        ...
        public async Task<ActionResult<Obrok>> DodajJeloObroku(int obrokID, int jeloID, double masa) 
        {
            var obrok = await iobrok.ObrokPoIDu(obrokID);
            if (obrok == null)
                return NotFound("Ne postoji traženi obrok.");
        ...
        public async Task<ActionResult<Obrok>> PromeniMasuJela(int obrokID, int jeloID, double masa)
        {
            var obrok = await iobrok.ObrokPoIDu(obrokID);
            if (obrok == null)
                return NotFound("Ne postoji traženi obrok.");
        ...
        public async Task<ActionResult<Obrok>> ObrisiJeloIzObroka(int obrokID, int jeloID) 
        {
            var obrok = await iobrok.ObrokPoIDu(obrokID);
            if (obrok == null)
                return NotFound("Ne postoji traženi obrok.");
        ...
        public async Task<ActionResult<string>> ObrisiObrok(int id) 
        {
        ...
        public async Task<ActionResult<string>> ObrisiDanasnjiObrok(int id)
        {
