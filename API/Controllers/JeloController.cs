namespace API.Controllers
{
    ...
    public class JeloController : ControllerBase
    {
        ...
        public async Task<ActionResult<Jelo>> NadjiJeloPoIDu(int id)
        {
        ...
        public async Task<ActionResult<Jelo>> SkalirajJelo(int jeloID, double masa) 
        {
        ...
        public async Task<ActionResult<ICollection<Namirnica>>> NamirniceJela(int id) 
        {
            var jelo = await ijelo.JeloPoIDu(id);
            if(jelo == null)
                return NotFound("Ne postoji traženo jelo.");
        ...
        public async Task<ActionResult<double>> MasaNamirnice(int jeloID, int namirnicaID) 
        {
            var jelo = await ijelo.JeloPoIDu(jeloID);
            if (jelo == null)
                return NotFound("Ne postoji traženo jelo.");
        ...
        public async Task<ActionResult<double>> MaseNamirnica(int jeloID)
        {
            var jelo = await ijelo.JeloPoIDu(jeloID);
            if (jelo == null)
                return NotFound("Ne postoji traženo jelo.");
        ...
        public async Task<ActionResult<Objava>> ObjaviJelo(int jeloID) 
        {
            var jelo = await ijelo.JeloPoIDu(jeloID);
            if (jelo == null)
                return NotFound("Ne postoji traženo jelo.");
        ...
        public async Task<ActionResult<Jelo>> PromeniNazivJela(int id, string naziv) 
        {
            var jelo = await ijelo.JeloPoIDu(id);
            if (jelo == null)
                return NotFound("Ne postoji traženo jelo.");
        ...
        public async Task<ActionResult<Jelo>> DodajNamirnicuJelu(int jeloID, int namirnicaID, double masa, bool pre) 
        {
            var jelo = await ijelo.JeloPoIDu(jeloID);
            if (jelo == null)
                return NotFound("Ne postoji traženo jelo.");
        ...
        public async Task<ActionResult<Jelo>> PromeniMasuNamirnice(int jeloID, int namirnicaID, double masa) 
        {
            var jelo = await ijelo.JeloPoIDu(jeloID);
            if (jelo == null)
                return NotFound("Ne postoji traženo jelo.");
        ...
        public async Task<ActionResult<string>> IspisiRecept(int jeloID) 
        {
            var jelo = await ijelo.JeloPoIDu(jeloID);
            if (jelo == null)
                return NotFound("Ne postoji traženo jelo.");
        ...
        public async Task<ActionResult<Jelo>> ObrisiNamirnicuIzJela(int jeloID, int namirnicaID)
        {
            var jelo = await ijelo.JeloPoIDu(jeloID);
            if (jelo == null)
                return NotFound("Ne postoji traženo jelo.");
        ...
        public async Task<ActionResult<string>> ObrisiJelo(int id)
        {
