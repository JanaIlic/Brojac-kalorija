namespace API.Controllers
{
    ...
    public class DanController : ControllerBase
    {
        ...
        public async Task<ActionResult<Dan>> NadjiDanPoIDu(int id) 
        {
        ...
        public async Task<ActionResult<Izvestaj>> NadjiIzvestaj( int danID) 
        {
        ...
        public async Task<ActionResult<bool>> JeLiDanas(int dID) 
        {
       ...
       [HttpPut("iskljuciIzvestaje"), Authorize(Roles ="Korisnik")]
        ...
        public async Task<ActionResult> ObrisiDan(int id)
        {
