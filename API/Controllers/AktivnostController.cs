namespace API.Controllers
{
    ...
    public class AktivnostController : ControllerBase
    {
        ...
        public async Task<ActionResult<Aktivnost>> AktivnostPoIDu(int id) 
        {
        ...
        public async Task<ActionResult<string>> Potrosnja(int aktivnostID, int minuti) 
        {
        ...
        public async Task<ActionResult<Aktivnost>> PromeniNazivAktivnosti(int id, string naziv)
        {
            var aktivnost = await iaktivnost.AktivnostPoIDu(id);
            if (aktivnost == null)
                return NotFound("Ne postoji tražena aktivnost.");
        ...
        public async Task<ActionResult<Aktivnost>> PromeniTezinuAktivnosti(int id, double nt)
        {
            var aktivnost = await iaktivnost.AktivnostPoIDu(id);
            if (aktivnost == null)
                return NotFound("Ne postoji tražena aktivnost.");
