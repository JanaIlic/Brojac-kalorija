namespace API.Controllers
{
    ...
    public class ZahtevNamirniceController : ControllerBase
    {
        ...
        public async Task<ActionResult<ZahtevNamirnice>> NadjiPoslatZahtev(int zahtevID)
        {
        ...
        public async Task<ActionResult<ZahtevNamirnice>> NadjiPrimljenZahtev(int zahtevID)
        {
        ...
        public async Task<ActionResult<ZahtevNamirnice>> PrihvatiZahtev(int zahtevID)
        {
            var zahtev = await izahtev.NadjiPrimljenZahtev(zahtevID);
            if (zahtev == null)
                return NotFound("Traženi zahtev ne postoji, ili je uklonjen.");
        ...
        public async Task<ActionResult<ZahtevNamirnice>> IspuniZahtev(int zahtevID, string naziv)
        {
            var zahtev = await izahtev.NadjiPrimljenZahtev(zahtevID);
            if (zahtev == null)
                return NotFound("Traženi zahtev ne postoji, ili je uklonjen.");
        ...
        public async Task<ActionResult<ZahtevNamirnice>> OdbijZahtev(int zahtevID)
        {
            var zahtev = await izahtev.NadjiPrimljenZahtev(zahtevID);
            if (zahtev == null)
                return NotFound("Traženi zahtev ne postoji, ili je uklonjen.");
        ...
        public async Task<ActionResult<ZahtevNamirnice>> PovuciZahtev(int zahtevID)
        {
