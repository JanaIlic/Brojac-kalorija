namespace API.Controllers
{
    ...
    public class ZahtevAktivnostiController : ControllerBase
    {
        ...
        public async Task<ActionResult<ZahtevAktivnosti>> NadjiPoslatZahtev(int zahtevID)
        {
        ...
        public async Task<ActionResult<ZahtevAktivnosti>> NadjiPrimljenZahtev(int zahtevID)
        {
        ...
        public async Task<ActionResult<ZahtevAktivnosti>> PrihvatiZahtev(int zahtevID) 
        {
            var zahtev = await izahtev.NadjiPrimljenZahtev(zahtevID);
            if(zahtev == null)
                return NotFound("Traženi zahtev ne postoji, ili je uklonjen.");
        ...
        public async Task<ActionResult<ZahtevAktivnosti>> IspuniZahtev(int zahtevID, string naziv)
        {
            var zahtev = await izahtev.NadjiPrimljenZahtev(zahtevID);
            if (zahtev == null)
                return NotFound("Traženi zahtev ne postoji, ili je uklonjen.");
        ...
        public async Task<ActionResult<ZahtevAktivnosti>> OdbijZahtev(int zahtevID)
        {
            var zahtev = await izahtev.NadjiPrimljenZahtev(zahtevID);
            if (zahtev == null)
                return NotFound("Traženi zahtev ne postoji, ili je uklonjen.");
        ...
        public async Task<ActionResult<ZahtevAktivnosti>> PovuciZahtev(int zahtevID) 
        {
