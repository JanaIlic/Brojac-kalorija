namespace API.Controllers
{
    ...
    public class NamirnicaController : ControllerBase
    {
        ...
        public async Task<ActionResult<Namirnica>> NadjiNamirnicu(int id) 
        {
        ...
        public async Task<ActionResult<Namirnica>> SkalirajNamirnicu(int id, double masa) 
        {
        ...
        public async Task<ActionResult<Namirnica>> PromeniNaziv(int id, string naziv) 
        {
            var namirnica = await inamirnica.NadjiNamirnicu(id);
            if (namirnica == null)
                return NotFound("Ne postoji tražena namirnica.");
        ...
        public async Task<ActionResult<Namirnica>> PromeniVrstu(int id, VrstaNamirnice vrsta)
        {
            var namirnica = await inamirnica.NadjiNamirnicu(id);
            if (namirnica == null)
                return NotFound("Ne postoji tražena namirnica.");
        ...
        public async Task<ActionResult<Namirnica>> PromeniTipObrade(int id, TipObrade tip)
        {
            var namirnica = await inamirnica.NadjiNamirnicu(id);
            if (namirnica == null)
                return NotFound("Ne postoji tražena namirnica.");
        ...
        public async Task<ActionResult<Namirnica>> PromeniKolicinuDodatogBrasna(int id, KolicinaBrasna brasno)
        {
            var namirnica = await inamirnica.NadjiNamirnicu(id);
            if (namirnica == null)
                return NotFound("Ne postoji tražena namirnica.");
        ...
        public async Task<ActionResult<Namirnica>> PromeniKolicnuDodateMasti(int id, KolicinaMasti mast)
        {
            var namirnica = await inamirnica.NadjiNamirnicu(id);
            if (namirnica == null)
                return NotFound("Ne postoji tražena namirnica.");
        ...
        public async Task<ActionResult<Namirnica>> PromeniEnergetskuVrednost(int id, double energetskaVrednost)
        {
            var namirnica = await inamirnica.NadjiNamirnicu(id);
            if (namirnica == null)
                return NotFound("Ne postoji tražena namirnica.");
        ...
        public async Task<ActionResult<Namirnica>> PromeniProtein(int id, double protein)
        {
            var namirnica = await inamirnica.NadjiNamirnicu(id);
            if (namirnica == null)
                return NotFound("Ne postoji tražena namirnica.");
        ...
        public async Task<ActionResult<Namirnica>> PromeniUH(int id, double uh)
        {
            var namirnica = await inamirnica.NadjiNamirnicu(id);
            if (namirnica == null)
                return NotFound("Ne postoji tražena namirnica.");
        ...
        public async Task<ActionResult<Namirnica>> PromeniMast(int id, double mast)
        {
            var namirnica = await inamirnica.NadjiNamirnicu(id);
            if (namirnica == null)
                return NotFound("Ne postoji tražena namirnica.");
        ...
        public async Task<ActionResult<Namirnica>> PromeniKoeficijent(int id, double promena)
        {
            var namirnica = await inamirnica.NadjiNamirnicu(id);
            if (namirnica == null)
                return NotFound("Ne postoji tražena namirnica.");
        ...
        public async Task<ActionResult<Namirnica>> PromeniOpis(int id, string promena)
        {
            var namirnica = await inamirnica.NadjiNamirnicu(id);
            if (namirnica == null)
                return NotFound("Ne postoji tražena namirnica.");
        ...
        public async Task<ActionResult> ObrisiNamirnicu(int id) 
        {
