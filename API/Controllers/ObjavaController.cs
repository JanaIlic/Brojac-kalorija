namespace API.Controllers
{
    ...
    public class ObjavaController : ControllerBase
    {
        ...
        public async Task<ActionResult<Objava>> ObjavaPoIDu(int objavaID)
        {
        ...
        public async Task<ActionResult<Objava>> ObjavaPracenog(int objavaID)
        {
        ...
        public async Task<ActionResult<bool>> ObjavaPrijavljenogKorisnika(int objavaID) 
        {
            var objava = await iobjava.ObjavaPoIDu(objavaID);
            if (objava == null)
                return NotFound("Ne postoji tražena objava.");
        ...
        public async Task<ActionResult<ICollection<Objava>>> Komentari(int objavaID)
        {
            var objava = await iobjava.ObjavaPoIDu(objavaID);
            if (objava == null)
        ...
        public async Task<ActionResult<Ocena>> OcenaNaObjavu(int objavaID)
        {
            var objava = await iobjava.ObjavaPoIDu(objavaID);
            if (objava != null)
        ...
        public async Task<ActionResult<ICollection<Ocena>>> Ocene(int objavaID)
        {
            var objava = await iobjava.ObjavaPracenog(objavaID);
            if (objava != null)
        ...
        public async Task<ActionResult<ICollection<Objava>>> SveObjavePracenog(int korisnikID)
        {
            return Ok(await iobjava.SveObjavePracenog(korisnikID));
        }

        [HttpGet("prosek/{objavaID}"), Authorize(Roles ="Korisnik")]
        public async Task<ActionResult<double>> Prosek(int objavaID) 
        {
            var objava = await iobjava.ObjavaPoIDu(objavaID);
            if (objava == null)
                objava = await iobjava.ObjavaPracenog(objavaID);
        ...
        public async Task<ActionResult<ICollection<Korisnik>>> AutoriKomentara(int objavaID)
        {
            var objava = await iobjava.ObjavaPoIDu(objavaID);
            if (objava == null)
                objava = await iobjava.ObjavaPracenog(objavaID);
        ...
        public async Task<ActionResult<ICollection<Korisnik>>> AutoriOcena(int objavaID)
        {
            var objava = await iobjava.ObjavaPoIDu(objavaID);
            if (objava == null)
                return NotFound("Ne postoji tražena objava.");
        ...
        public async Task<ActionResult<Objava>> KomentarPratioca(int komID) 
        {
        ...
        public async Task<ActionResult<Objava>> KomentarPrijavljenog(int komID)
        {
        ...
        public async Task<ActionResult<Objava>> KomentarisiObjavuPracenom(int objavaID, string tekst)
        {
            var objava = await iobjava.ObjavaPracenog(objavaID);
            if (objava == null)
                return NotFound("Ne postoji tražena objava.");
        ...
        public async Task<ActionResult<Objava>> KomentarisiSvojuObjavu(int objavaID, string tekst)
        {
            var objava = await iobjava.ObjavaPoIDu(objavaID);
            if (objava == null)
                return NotFound("Ne postoji tražena objava.");
        ...
        public async Task<ActionResult<Objava>> Oceni(int objavaID, int vrednost) 
        {
            var objava = await iobjava.ObjavaPoIDu(objavaID);
            if (objava != null)
        ...
        public async Task<ActionResult<Objava>> PromeniObjavu(int objavaID, string tekst)
        {
        ...
        public async Task<ActionResult<Objava>> PovuciOcenu(int objavaID)
        {
           var objava = await iobjava.ObjavaPracenog(objavaID);
                    if (objava == null)
                         return NotFound("Ne postoji tražena objava.");
        ...
        public async Task<ActionResult<string>> ObrisiObjavu(int objavaID)
        {
        ...
        public async Task<ActionResult<ICollection<Objava>>> ObrisiKomentar(int objavaID)
        {
