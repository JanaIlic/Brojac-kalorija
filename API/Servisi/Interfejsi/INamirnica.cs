namespace API.Servisi.Interfejsi
{
    public interface INamirnica
    {
        ...
        public Task<Namirnica> NadjiNamirnicu(int id);
        ...
        public Task<string> ObrisiNamirnicu(int id);

        public Task<Namirnica> UpisPrveNamirnice();
        public Task UpisPrvihNamirnica();
        public Task PromenaPrvihNamirnica();
        public Task BrisanjePrvihNamirnica();
    }
}
