...
builder.Services.AddDbContext<DataContext>(options => {
    options.UseSqlServer(builder.Configuration.GetConnectionString("BrojacDBConnection"));
}); */

builder.Services.AddDbContext<DataContext>(options => {
    options.UseNpgsql(builder.Configuration.GetConnectionString("BrojacDBConnection"));
...
Log.Logger = new LoggerConfiguration().MinimumLevel.Information().
    WriteTo.File("logs/SqlLog.txt", rollingInterval: RollingInterval.Infinite).CreateLogger();
